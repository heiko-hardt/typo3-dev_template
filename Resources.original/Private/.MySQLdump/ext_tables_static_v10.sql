...
INSERT INTO `sys_template`
        (`uid`, `pid`, `title`, `sitetitle`, `root`, `clear`, `include_static_file`, `constants`)
    VALUES
        (1,1,'Root - Template','TYPO3 Sandbox environment',1,3,'EXT:dev_template/Configuration/TypoScript','config{\r\n  headerTitle = TYPO3 Dev.Sandbox 10.4 LTS\r\n  pids {\r\n    Home = 1\r\n    Meta = 100\r\n  }\r\n}')
    ;
